define([
    ...
    let helper = {
        ...
        open:(object)=>{
            let objectToOpen = objectService.isObjectAvailableToCharacter(object, "player") ? objects[object] : null;
        ...
        unlock: (directObject, preposition, indirectObject)=>{
            ...
            if (!objectService.isObjectAvailableToCharacter(directObject, "player")) return ioService.Response.say("You don't see that here!");
            ...
            if (!objectService.characterHasObject(objectToUnlock.can.unlock.with, "player") && !indirectObject) return ioService.Response.say(`You don't seem to have anything that can unlock the ${ directObject }.`);
            if (objectService.characterHasObject(objectToUnlock.can.unlock.with, "player") && !!indirectObject && objectService.characterHasObject(indirectObject, "player")) return ioService.Response.say(`Um, you don't have *THAT* to unlock the ${ directObject }.`);
            if (!objectService.characterHasObject(objectToUnlock.can.unlock.with, "player")) return ioService.Response.say(`You don't seem to have anything that can unlock the ${ directObject }.`);
        ...
        drop: (object)=>{
            ...
            if (!objectService.characterHasObject(object, "player")) return ioService.Response.say(`But you don't have a ${ object }.`);
